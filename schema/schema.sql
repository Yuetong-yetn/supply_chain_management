...
CREATE TABLE inventory (
	...
	PRIMARY KEY (id), 
	CONSTRAINT uq_inv_product_wh UNIQUE (product_id, warehouse_id), 
	CONSTRAINT uq_inv_product_store UNIQUE (product_id, store_id), 
	CONSTRAINT ck_inv_current CHECK (current_quantity >= 0), 
	CONSTRAINT ck_inv_frozen CHECK (frozen_quantity >= 0), 
	FOREIGN KEY(product_id) REFERENCES products (id), 
	FOREIGN KEY(warehouse_id) REFERENCES warehouses (id), 
	FOREIGN KEY(store_id) REFERENCES stores (id)
);
